...
class ProductModel extends Model
{
    ...
    public function get_fav()
    {
        ...
        $builder->select('tbl_products.*, tbl_favorites.product_id, tbl_favorites.username')
            ->join('tbl_favorites', 'tbl_favorites.product_id = tbl_products.id AND tbl_favorites.username = ' . $this->db->escape($this->session->get('username')) . '', 'left')->where('tbl_favorites.username', $this->session->get('username'));
