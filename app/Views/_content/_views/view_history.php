  ...
  <table id="myTable" class="table text-nowrap mb-0 align-middle">
    <thead class="text-dark fs-4">
      <tr>
        ...
        <th class="border-bottom-0">
          <h6 id="id" class="fw-semibold mb-0">Kolom 1</h6>
        </th>
        <th class="border-bottom-0">
          <h6 id="username" class="fw-semibold mb-0">Kolom 2</h6>
        </th>
        <th class="border-bottom-0">
          <h6 id="product_id" class="fw-semibold mb-0">Kolom 3</h6>
        </th>
        <th class="border-bottom-0">
          <h6 id="qty" class="fw-semibold mb-0">Kolom 4</h6>
        </th>
        <th class="border-bottom-0">
          <h6 id="price" class="fw-semibold mb-0">Kolom 5</h6>
        </th>
      </tr>
    </thead>
    <tbody></tbody>
