          ...
          <div class="row">
              <div class="col-lg-3">
                <div class="form-group focused">
                  ...
                  <input type="text" id="input-city" class="form-control form-control-alternative" placeholder="City" value="-- Pilih Salah Satu --">
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group focused">
                  <label class="form-control-label" for="input-country">Kabupaten / Kota</label>
                  <input type="text" id="input-country" class="form-control form-control-alternative" placeholder="Country" value="-- Pilih Salah Satu --">
                </div>
              </div>
              <div class="col-lg-3">
                <div class="form-group focused">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group focused">
                  <label class="form-control-label" for="input-address">Alamat Domisili</label>
                  <input id="input-address" class="form-control form-control-alternative" placeholder="Home Address" value="Harap masukkan nama jalan, nomor rumah, dan kode pos dengan lengkap !" type="text">
                </div>
              </div>
            </div>
          </div>
